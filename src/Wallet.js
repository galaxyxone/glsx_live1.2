...
class Wallet extends Component {
  ...
  async getBalance() {
    ...
    if (DataisLoaded && profile.app_metadata) {
      ...
      let balance = await contractInstance.methods.balanceOf(profile.app_metadata.walletaddr)
      console.log(balance)
  ...
  render() {
    const { DataisLoaded, profile, balance } = this.state;
    if (!DataisLoaded)
      return (
        <div>
